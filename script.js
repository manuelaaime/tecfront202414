...
function validateIfExistsNewTask()
{
    ...
    let inputValue = document.getElementById('input-nova-anotacao').value
...
function newTask()
{
    let input = document.getElementById('input-nova-anotacao')
    input.style.border = ''
...
document.getElementById("username-display").textContent = `Bem-vindo a sua To-Do-List, ${username}!`;
